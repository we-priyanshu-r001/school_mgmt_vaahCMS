...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-school';
        ...
        */
        ...
        return view('school::backend.pages.app');
...
//        $steps[] = $this->isSetupComplete();
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.school_version')??config('school.version'),
            'is_dev' => config('school.is_dev'),
            'setup' => [
                'steps' => $steps
            ]
        ];
