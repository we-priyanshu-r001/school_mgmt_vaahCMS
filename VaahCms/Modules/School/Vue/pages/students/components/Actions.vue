        ...
        <div :class="{'flex justify-content-between': store.isViewLarge()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'large'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="students-actions-menu"
                    aria-haspopup="true"
                ...
                <!--/selected_menu-->
                 ...
                 <Button
                    ...
                    data-testid="students-actions-show-advance-filters"
                    ...
                    <div class="col-12">
                        <div class="p-inputgroup ">
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="students-actions-search"
                                       placeholder="Search"/>
                            <Button @click="store.delayedSearch()"
                                    class="p-button-sm"
                                    data-testid="students-actions-search-button"
                                    icon="pi pi-search"/>
                            <Button
                                type="button"
                                class="p-button-sm"
                                :disabled="Object.keys(route.params).length"
                                data-testid="students-actions-show-filters"
                            ...
                            <Button
                                ...
                                data-testid="students-actions-reset-filters"
                                class="p-button-sm"
                                label="Reset"
                                ...
                                <Button
                                    ...
                                    data-testid="students-actions-bulk-menu"
                                    aria-haspopup="true"
