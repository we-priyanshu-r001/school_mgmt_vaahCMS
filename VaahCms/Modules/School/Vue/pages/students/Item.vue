            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    ...
                    <Button label="Edit"
                            ...
                            data-testid="students-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button
                        ...
                        data-testid="students-item-menu"
                    ...
                    <Button class="p-button-primary p-button-sm"
                            icon="pi pi-times"
                            data-testid="students-item-to-list"
                            @click="store.toList()"/>
            ...
            <div class="mt-2" v-if="store.item">
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="ml-3">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="students-item-restore"
                ...
                <table class="p-datatable-table overflow-wrap-anywhere">
                    ...
                    <template v-for="(value, column) in store.item ">
                        ...
                        || column === 'vh_taxonomy_gender_id' || column === 'sc_batch_id' ">
                        </template>
